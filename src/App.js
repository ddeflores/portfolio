...
function App() {
  ...
  function scrollFunction() {
    ...
    if (
      scrollTop <= 20 ||
      scrollTop + windowHeight + threshold >= documentHeight
    ) {
      ...
      <div class="container" id="top">
        <div class="navbar" id="navbar">
          ...
          <div class="navbarContainer">
            ...
            <div class="redirects" onClick={handleProjectsClick}>
              Projects
            </div>
            <div class="redirects" onClick={handleContactClick}>
              Contact
            </div>
            <a
              href="https://www.linkedin.com/in/danieldeflores/"
              style={{ marginInline: "5px" }}
            >
              <img src={linkedin} alt="linkedin" height="40" width="40" />
            </a>
            <a
              href="https://github.com/ddeflores"
              style={{ marginInline: "5px" }}
            >
        ...
        <div class="bottomContainer">
          <div class="aboutMe">
            ...
            />
            <div class="preface">I'm a software engineer.</div>
            <div
              class="preface"
              style={{
                borderBottom: "2px solid #BFA181",
                paddingBottom: "20px",
              }}
            >
              Before I show you some of my work, here's a little bit about my
              connection with computer science.
            </div>
            <div class="paragraph" style={{ paddingTop: "75px" }}>
              Computer science, to me, is not just a field of study but an
              outlet for creativity. I have always loved tinkering with the
              technology around me and figuring out how things work. Computer
              science gives me the opportunity to solve intricate problems in
              creative ways. It offers the unique potential to transform the
              world, and my primary motivation lies in developing solutions that
              address real-world challenges. Whether for healthcare,
              environmental sustainability, or education, each line of code is a
              step towards a better future.
            </div>
            <div class="paragraph">
              My main career goal is to align with an organization that shares
              my perspective on the transformative power of computer science. I
              am very passionate about creating dependable software that is
              accessible to everyone. The potential of AI to revolutionize
              mental healthcare and offer life-changing support to those
              affected by mental illness is something that especially resonates
              with me. I would love to contribute to and grow in an environment
              that is actively shaping solutions that heal and empower others.
            </div>
            <span class="conclusion">
              If you've taken the time to read through everything, feel free to
              ...
              <div class="section">
                <div class="links" style={{ borderTop: "2px solid #BFA181" }}>
                  ...
                  <p style={{ marginBottom: "50px" }}>
                    I've worked with Capital Technology Group full-time since
                    May 2025. I've worked on one project, which included a React
                    Native app, a React web app, and a SpringBoot backend during
                    my full time employment. Although my time at Capital
          ...
          <div class="body" id="projects">
            ...
            <div class="projects">
              <div class="section">
                <div class="links" style={{ borderTop: "2px solid #BFA181" }}>
                  <a
                    style={{ textDecoration: "none" }}
                    href="https://github.com/ddeflores/Food-Finder"
                  >
                    <div class="name" style={{ marginTop: "50px" }}>
                      FoodFinder
                    </div>
                  ...
                  <h3>
                    ...
                    Tensorflow.js, Python, OpenAI API
                  </h3>
                  <video
                    poster={foodfinder}
                    playsInline
                  ...
                  <p style={{ marginBottom: "50px" }}>
                    This is my most exciting project yet! I've always wanted a
                    MyFitnessPal type app, but with a smoother, more modern UI.
                    Hence, why I started making FoodFinder. It's still a work in
                    progress, but I'm very enthusiastic about adding more
                    features. I eventually want to post this to the App Store
                    and Google Play Store. The coolest feature in my opinion is
                    the ability to upload images of foods and receive
                    estimations of how many calories are in them. Perfect for
                    people who aren't very well-versed in nutrition! For the
                    time being, I don't have this deployed anywhere, but I
                    included a demo video above. It showcases how users can log
                    food by taking pictures, how users can log food manually,
                    and a few other things like editing and deleting foods in
                    the log, and the acount page.
                  </p>
                </div>
              </div>
              <div class="section">
                <div class="links">
                  <a
                    href="https://eorev.github.io/Chirp/"
                    style={{ textDecoration: "none" }}
                  >
                  ...
                  <p style={{ marginBottom: "50px" }}>
                    I worked on Chirp with a team for a 24 hour hackathon,
                    HenHacks 2023, which was hosted by the University of
                    Delaware. Chirp was designed for students of all ages and CS
                    backgrounds learning sorting algorithms. Our main focus was
                    to have a very clean UI that would be easily accessible,
                    even for children. My team and I achieved second place in
                    the Educational category for our design and efforts, out of
                    over 150 competitors! I'm very proud of the outcome of our
                    hard work, but regardless of how we did I'm glad I had such
                    a great learning experience for my first hackathon!
                  </p>
                </div>
              </div>
              <div class="section">
                <div class="links">
                  ...
                  <p style={{ marginBottom: "50px" }}>
                    This is some research my peer and I conducted. We compared
                    convolutional neural networks (CNN) to recurrent neural
                    networks (RNN) in their effectiveness classifying URLs as
                    phishing or non-phishing. We trained each model on a dataset
                    of over 800,000 URLs, and eventually concluded that CNNs are
                    more effective when processing time is taken into account.
                    It proved to be a great learning experience, and it also
                    sparked my interest in AI/ML! If you want to check out my
                    portion of the work (the CNN model), you can
                    <span
              ...
              <div class="section">
                <div class="links">
                  <a
                    href="https://github.com/ddeflores/ChessGame"
                    style={{ textDecoration: "none" }}
                  >
                    <div class="name">Chess Game</div>
                  </a>
                  ...
                  <p style={{ marginBottom: "50px" }}>
                    I wanted to practice my Object Oriented Programming skills
                    and figured Chess was a great starting point, especially
                    since I'm quite passionate about it! In this program, I
                    implemented the classic rules of chess. If you want to see
                    how it works, I included a short demo video of some gameplay
            ...
            <div class="section">
              ...
              <div class="paragraph">
                I love coffee and trying out new coffee shops whenever I go
                somewhere new. It's also my favorite pre-workout for lifting or
                running!
              </div>
              <div class="paragraph">
                Before I started my career in computer science, I was hoping for
                a career in baseball. Its been a passion of mine for over 10
                years, and its nice to watch a game here and there to relax. My
              ...
              >
                I also love playing chess and poker. Nothing beats a cool
                checkmate or bluffing my way to a win with 7-2 offsuit!
              </div>
            </div>
            <div class="section">
              <div class="thankYou">
                <div>Thank you for taking the time to read all of this!</div>
                <div class="name" style={{ marginTop: "10px" }}>
              ...
              <div class="thankYou" id="thankYou">
                ...
                <div class="name" style={{ marginTop: "5px" }}>
                  or
                </div>
