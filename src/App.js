    ...
    return (
        ...
        <div class="bottomContainer">
            <div class="aboutMe">
                ...
                <div class="paragraph">
                I love coffee! Its fun trying out new coffee shops whenever I go somewhere new. 
                Its also my favorite preworkout for lifting or running! If you're interested,
            ...
            <div class="extras">
                <div class="information">
                        <img src={rook} alt='rook coffee logo' height={170} width={155}/>
                        <img src={mets} alt='new york mets logo' height={170} width={170}/>
                </div>
                <div class="information">
                    <div>My favorite coffee shop!</div> 
                    <div>I will forever be a Mets fan!</div>
                </div>
            </div>
            <div class="body" id="projects">
                ...
                <div class="preface">(You can click on the titles and check them out!)</div>
                    <div class="projects">
                        ...
                        <div class="links">
                            ...
                            this deployed anywhere except for my laptop, but I included a screenshot of the GUI.
                            </p>
                        </div>
                    </div>
                </div>
